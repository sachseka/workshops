...
## Subitems, Items, Aufgaben und Werte und Codes {.smaller}

![](pics/cyclehire1.jpg){fig-width="60%" fig-align="center"}

::: footer
2a. Subitems in Items in Aufgaben {.smaller}
:::
...
-   Subitems: werden zu Items aggregiert

-   Items: (meist) die am Ende interessierende Analyseeinheit

-   Aufgaben: beinhalten Items

-   Blöcke: bestehen aus Aufgaben

-   Testhefte: bestehen aus Blöcken
