...
::: {.small-text-compact}
(Dieses liegt unter **i:\\EDV\\IQB-Apps\\ZKDaemon\\ZKDaemon.application**. 
Eine ausführlichere, via Screenshots geführte Anleitung zur Bedienung des ZKDaemon findet sich hier:\
...
```{r prepDat}
# Vorbereitung falls die Pfade für die SPSS-Dateien nicht in der InputListe eingetragen sind
