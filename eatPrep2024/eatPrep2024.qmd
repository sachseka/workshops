...
3.  Praktisch angewendet
    ...
    b)  Kategorientrennschärfen
    c)  Testsitzungsprotokolle
    d)  Beurteilerübereinstimmung (Rater-Funktionen)
...
1.  Lest die Meta-Daten (inputListe) und Daten (booklet1.sav, booklet2.sav, booklet3.sav) ein und lasst diese automatisiert prüfen. Bereitet die Daten bis zum gescorten Zustand weiter auf (entweder ein einzelnen Schritten oder gebündelt).

2.  Exportiert die aufbereiteten (aber "uncollapsten") Daten ins eatGADS-Format.

3.  Überprüft, ob die Daten zum Testdesign passen oder ob es Dateneinträge gibt, wo per Design fehlende Werte sein müssten oder per Design fehlende Werte, wo es valide Codes oder andere Missingtypen geben müsste.
